...
public class Motorista {
    ...
    protected Motorista(String nome, int idade, int pontos, String habilitacao) {
        this.nome = nome;
        this.idade = idade;
        this.pontos = pontos;
    ...
    public static class MotoristaBuilder {
        ...
        public Motorista build() {
            ...
            if (idade < 18) throw new EstacionamentoException("Motorista deve ser maior de idade");
            if (pontos > 20) throw new EstacionamentoException("Motorista não pode estar com habilitação suspensa");
